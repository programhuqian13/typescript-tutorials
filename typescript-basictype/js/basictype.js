...
var username1 = "Gren";
var age = 37;
var sentece = "Hello world,my name is " + username1 + ".\n        i'll be " + (age + 1) + " years old next month\n    ";
...
//元组
//定义一个元组
var tuple; //定义一个元组元素，里面是string和number
...
var CoustomColor;
(function (CoustomColor) {
    CoustomColor[CoustomColor["RED"] = 1] = "RED";
    CoustomColor[CoustomColor["GREEN"] = 2] = "GREEN";
    CoustomColor[CoustomColor["BLUE"] = 3] = "BLUE";
})(CoustomColor || (CoustomColor = {}));
var cons = CoustomColor.RED;
console.log(cons);
//枚举类型提供的一个便利是你可以根据枚举值得到它的名字
var CoustomColor2;
(function (CoustomColor2) {
    CoustomColor2[CoustomColor2["RED"] = 1] = "RED";
    CoustomColor2[CoustomColor2["GREEN"] = 2] = "GREEN";
    CoustomColor2[CoustomColor2["BLUE"] = 3] = "BLUE";
})(CoustomColor2 || (CoustomColor2 = {}));
var consStr = CoustomColor2[2];
console.log(consStr);
//Any
var andvalue = 4;
